...
export const countryLabels: CountryLabel[] = [
  ...
  { name: 'GREECE', lat: 39.1, lng: 21.8, size: 'small' },
  { name: 'ROMANIA', lat: 45.9, lng: 25.0, size: 'small' },
  { name: 'HUNGARY', lat: 47.2, lng: 19.5, size: 'small' },
  { name: 'CZECH REP.', lat: 49.8, lng: 15.5, size: 'small' },
  { name: 'AUSTRIA', lat: 47.5, lng: 14.6, size: 'small' },
  { name: 'SWITZERLAND', lat: 46.8, lng: 8.2, size: 'small' },
  { name: 'NETHERLANDS', lat: 52.1, lng: 5.3, size: 'small' },
  { name: 'BELGIUM', lat: 50.5, lng: 4.5, size: 'small' },
  { name: 'PORTUGAL', lat: 39.4, lng: -8.2, size: 'small' },
  { name: 'IRELAND', lat: 53.1, lng: -7.7, size: 'small' },
  { name: 'DENMARK', lat: 56.3, lng: 9.5, size: 'small' },
  { name: 'ICELAND', lat: 64.9, lng: -19.0, size: 'small' },
  { name: 'SERBIA', lat: 44.0, lng: 21.0, size: 'small' },
  { name: 'CROATIA', lat: 45.1, lng: 15.2, size: 'small' },
  { name: 'BULGARIA', lat: 42.7, lng: 25.5, size: 'small' },
  { name: 'BELARUS', lat: 53.7, lng: 27.9, size: 'small' },
  { name: 'LITHUANIA', lat: 55.2, lng: 23.9, size: 'small' },
  { name: 'LATVIA', lat: 56.9, lng: 24.1, size: 'small' },
  { name: 'ESTONIA', lat: 58.6, lng: 25.0, size: 'small' },
  { name: 'MOLDOVA', lat: 47.4, lng: 28.4, size: 'small' },
  { name: 'ALBANIA', lat: 41.2, lng: 20.2, size: 'small' },
  { name: 'GEORGIA', lat: 42.3, lng: 43.4, size: 'small' },

  // Arctic/North Atlantic
  { name: 'GREENLAND', lat: 71.7, lng: -42.6, size: 'medium' },
  { name: 'SVALBARD', lat: 78.2, lng: 15.6, size: 'small' },
  ...
  { name: 'YEMEN', lat: 15.6, lng: 48.5, size: 'small' },
  { name: 'OMAN', lat: 21.5, lng: 55.9, size: 'small' },
  { name: 'JORDAN', lat: 31.2, lng: 36.5, size: 'small' },
  { name: 'LEBANON', lat: 33.9, lng: 35.9, size: 'small' },
  { name: 'KUWAIT', lat: 29.3, lng: 47.5, size: 'small' },
  { name: 'QATAR', lat: 25.4, lng: 51.2, size: 'small' },
  { name: 'BAHRAIN', lat: 26.1, lng: 50.5, size: 'small' },
  ...
  { name: 'VIETNAM', lat: 14.1, lng: 108.3, size: 'small' },
  { name: 'THAILAND', lat: 15.9, lng: 100.9, size: 'small' },
  { name: 'MYANMAR', lat: 19.8, lng: 96.1, size: 'small' },
  { name: 'PHILIPPINES', lat: 12.9, lng: 121.8, size: 'small' },
  { name: 'MALAYSIA', lat: 4.2, lng: 101.9, size: 'small' },
  { name: 'BANGLADESH', lat: 23.7, lng: 90.4, size: 'small' },
  { name: 'AFGHANISTAN', lat: 33.9, lng: 67.7, size: 'small' },
  { name: 'MONGOLIA', lat: 46.9, lng: 103.8, size: 'small' },
  { name: 'KAZAKHSTAN', lat: 48.0, lng: 67.0, size: 'medium' },
  { name: 'UZBEKISTAN', lat: 41.4, lng: 64.6, size: 'small' },
  { name: 'SRI LANKA', lat: 7.9, lng: 80.8, size: 'small' },
  { name: 'NEPAL', lat: 28.4, lng: 84.1, size: 'small' },
  { name: 'SINGAPORE', lat: 1.4, lng: 103.8, size: 'small' },
  { name: 'CAMBODIA', lat: 12.6, lng: 105.0, size: 'small' },
  ...
  { name: 'ALGERIA', lat: 28.0, lng: 1.7, size: 'medium' },
  { name: 'MOROCCO', lat: 31.8, lng: -7.1, size: 'small' },
  { name: 'TUNISIA', lat: 34.0, lng: 9.5, size: 'small' },
  { name: 'ANGOLA', lat: -11.2, lng: 17.9, size: 'small' },
  { name: 'CONGO', lat: -4.3, lng: 15.3, size: 'small' },
  { name: 'DR CONGO', lat: -4.0, lng: 21.8, size: 'small' },
  { name: 'TANZANIA', lat: -6.4, lng: 34.9, size: 'small' },
  { name: 'MOZAMBIQUE', lat: -18.7, lng: 35.5, size: 'small' },
  { name: 'SOMALIA', lat: 5.2, lng: 46.2, size: 'small' },
  { name: 'MALI', lat: 17.6, lng: -4.0, size: 'small' },
  { name: 'NIGER', lat: 17.6, lng: 8.1, size: 'small' },
  { name: 'GHANA', lat: 7.9, lng: -1.0, size: 'small' },
  { name: 'MADAGASCAR', lat: -18.8, lng: 46.9, size: 'small' },
  ...
  { name: 'PERU', lat: -9.2, lng: -75.0, size: 'small' },
  { name: 'BOLIVIA', lat: -16.3, lng: -63.6, size: 'small' },
  { name: 'ECUADOR', lat: -1.8, lng: -78.2, size: 'small' },
  { name: 'PARAGUAY', lat: -23.4, lng: -58.4, size: 'small' },
  { name: 'URUGUAY', lat: -32.5, lng: -55.8, size: 'small' },
  { name: 'CUBA', lat: 21.5, lng: -79.0, size: 'small' },
  { name: 'GUATEMALA', lat: 15.8, lng: -90.2, size: 'small' },
  { name: 'ALASKA', lat: 64.2, lng: -153.4, size: 'small' },
  { name: 'HAWAII', lat: 19.9, lng: -155.6, size: 'small' },

  // Oceania
  { name: 'NEW ZEALAND', lat: -40.9, lng: 174.9, size: 'small' },
  { name: 'PAPUA N.G.', lat: -6.3, lng: 143.9, size: 'small' },
  { name: 'FIJI', lat: -17.7, lng: 178.0, size: 'small' },
  ...
  { name: 'SOUTHERN OCEAN', lat: -65.0, lng: 0.0, size: 'medium' },
  { name: 'MEDITERRANEAN', lat: 36.0, lng: 18.0, size: 'small' },
  { name: 'S. CHINA SEA', lat: 12.0, lng: 114.0, size: 'small' },
  { name: 'RED SEA', lat: 20.0, lng: 38.5, size: 'small' },
  { name: 'PERSIAN GULF', lat: 26.5, lng: 51.0, size: 'small' },
  { name: 'BLACK SEA', lat: 43.0, lng: 34.0, size: 'small' },
  { name: 'CARIBBEAN SEA', lat: 15.0, lng: -73.0, size: 'small' },
];
